...
public class NumberOfPermissionsComparator<MobileApp> implements Comparator<MobileApp> {
   ...
   *
   * Compare two MobileApp object by total number of permissions
   *
  ...
  public int compare(MobileApp o1, MobileApp o2) {
    return Integer.compare(((P2.MobileApp) o1).getRequestedPermissions().size(),
        ((P2.MobileApp) o2).getRequestedPermissions().size());
  }
}
